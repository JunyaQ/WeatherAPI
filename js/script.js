...
$('#history').on('click','.cityclass',function(e){
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q='+historycity+'&appid=c7a06032b7a947e2ad991c8e63f709c1')
...
function displayforecast(lat,lon,unixdate){
    ...
    fetch('https://api.openweathermap.org/data/2.5/onecall?lat='+lat+'&lon='+lon+'&dt='+unixdate+'&appid=c7a06032b7a947e2ad991c8e63f709c1')
        ...
        we1.setAttribute("src","https://openweathermap.org/img/wn/"+weathercode1+"@2x.png");
        ...
        we2.setAttribute("src","https://openweathermap.org/img/wn/"+weathercode2+"@2x.png");
        ...
        we3.setAttribute("src","https://openweathermap.org/img/wn/"+weathercode3+"@2x.png");
        ...
        we4.setAttribute("src","https://openweathermap.org/img/wn/"+weathercode4+"@2x.png");
        ...
        we5.setAttribute("src","https://openweathermap.org/img/wn/"+weathercode5+"@2x.png");
...
searchBtn.addEventListener("click", function(){
    ...
    //console.log(city);
    fetch('https://api.openweathermap.org/data/2.5/weather?q='+city+'&appid=c7a06032b7a947e2ad991c8e63f709c1')
    .then(response => response.json())
    .then(data => {
        //console.log(data);
        var city = data['name'];
